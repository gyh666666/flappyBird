...
export class Sprite{
    constructor(img=null,srcX=0,srcY=0,srcW=0,srcH=0,x=0,y=0,width=0,height=0){
        ...
        this.img=img;   //图片
        this.srcX=srcX; //图片起始x坐标
        this.srcY=srcY; //图片起始y坐标
        this.srcW=srcW; //图片的宽
        this.srcH=srcH; //图片的高
        this.x=x;       //在画布上的x坐标
        this.y=y;       //在画布上的y坐标
    ...
    //画图
    draw(img=this.img,srcX=this.srcX,srcY=this.srcY,srcW=this.srcW,srcH=this.srHc,x=this.x,y=this.y,width=this.width,height=this.height){
